...
class MedicineDetailBody extends StatefulWidget {
  ...
  const MedicineDetailBody({super.key, required this.item});
        ...
        children: [
              ...
              cardContainer(
                child: Column(
                  ...
                  children: [
                    ...
                    detailText("Kategori", item.category),
                    detailText("Deskripsi", item.description),
                    detailText("Indikasi Umum", item.indication),
                    detailText("Komposisi", item.composition),
                    detailText("Dosis", item.dosage),
                    detailText("Aturan Pakai", item.usage),
                    detailText("Efek Samping", item.sideEffects),
                  ],
                ),
              ),
            ],
          ...
          Positioned(
            ...
            child: ElevatedButton(
              onPressed: () {
                context.read<AppStateCubit>().addItemToCart(widget.item);
                showCustomMessage(
