...
class JamPendaftaran extends StatefulWidget {
  final DoctorModel doctor;
  final VoidCallback onBack;

  const JamPendaftaran({super.key, required this.doctor, required this.onBack});

  @override
  State<JamPendaftaran> createState() => _JamPendaftaranState();
}

class _JamPendaftaranState extends State<JamPendaftaran> {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              CircleAvatar(
                radius: 87,
                backgroundImage: const AssetImage('assets/logo/thankyou.png'),
